    ...
    theme: {
        extend: {
            ...
            boxShadow: {
                ...
                // Base: #FDFBF7 (Yellowish White)

                // Standard Raised Element (Card, Container)
                'skeuo-sm': '5px 5px 10px #e4e2de, -5px -5px 10px #ffffff',
                'skeuo-md': '8px 8px 16px #e4e2de, -8px -8px 16px #ffffff',
                'skeuo-lg': '12px 12px 24px #e4e2de, -12px -12px 24px #ffffff',

                // Pressed/Inset Element (Input, Active Button)
                'skeuo-inset-sm': 'inset 2px 2px 5px #e4e2de, inset -2px -2px 5px #ffffff',
                'skeuo-inset-md': 'inset 5px 5px 10px #e4e2de, inset -5px -5px 10px #ffffff',

                // Convex/Concave specific (Buttons)
                'skeuo-convex': '6px 6px 12px #d5d3cf, -6px -6px 12px #ffffff',

                // Floating/Active state
                'skeuo-floating': '14px 14px 28px #e4e2de, -14px -14px 28px #ffffff, 0 4px 20px rgba(32, 178, 170, 0.2)',
            },
            keyframes: {
                'glow-subtle': {
                    '0%, 100%': {
